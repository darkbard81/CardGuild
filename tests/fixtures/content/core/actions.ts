import type { ActionDefinition } from "../../../../src/game";

/**
 * The Action set the tactical rules are tested against: movement, Strike and its Reaction,
 * a skill check, an object interaction, a sustained effect and a shield.
 */
export const CORE_ACTIONS: readonly ActionDefinition[] = [
  {
    id: "step",
    name: "Step",
  ...
  },
  {
    ...
    resolution: {
      ...
      effects: [
        {
          kind: "create-sustained-effect",
          effectName: "Spirit Beacon",
        },
      ],
    },
  },
