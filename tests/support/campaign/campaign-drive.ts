...
import { heroIntent, reactionIntent, advancementIntent } from "../../support/campaign/adventure-driver";
...
export function nextIntent(snapshot: ServerSnapshot): SessionIntent | null {
  ...
  if (adventure.phase === "between-encounters" || adventure.phase === "ready") return advancementIntent(adventure) ?? { type: "start-encounter" };
