...
import { MIGRATIONS, migrate } from "../../src/server/persistence/migrations";
import { createPersistence, createSqlitePersistence, openDatabase } from "../../src/server/persistence/sqlite-persistence";
import { USERNAME_TAKEN, type CampaignSaveCommit, type Persistence } from "../../src/server/persistence/types";
...
describe("campaign snapshot storage", () => {
