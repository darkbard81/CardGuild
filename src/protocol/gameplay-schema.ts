import { MEMBER_IDENTITY_SCHEMA } from "../character/member-schema";
...
const adventure = {
  ...
  properties: {
    ...
    partyOrigin: { enum: ["authored", "player-created"] },
      ...
      properties: {
        members: {
          ...
          additionalProperties: {
            type: "object",
            additionalProperties: false,
            required: ["id", "seat", "actorDefinitionId", "loadout", "progression", "identity"],
            properties: {
              id: nonEmptyString,
              seat: { enum: [1, 2, 3] },
              ...
              identity: MEMBER_IDENTITY_SCHEMA,
            },
          },
        },
      },
