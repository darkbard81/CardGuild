...
- Domain `creation.test.ts`: valid/invalid choices, cosmetic gender, independent Campaigns, starter once, same-Class companion, current growth/Loadout/HP across save and next encounter, initial checkpoint, ingress rejection, wire shape and old-save preservation.
